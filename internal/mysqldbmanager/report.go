...
func renderText(report RunReport) string {
	...
	if report.PreCheck != nil {
		sb.WriteString(renderPreCheckText(*report.PreCheck, report.Command))
		sb.WriteString("\n")
	}
	...
	if report.DropResult != nil {
		sb.WriteString(renderDropResultText(*report.DropResult))
	}
	...
	if report.DryRun {
		...
		if report.Command == "drop" {
			sb.WriteString("\nTo proceed with deletion, run the same command without --dry-run\n")
		}
		sb.WriteString("================================================================\n")
	}
...
func renderPreCheckText(report PreCheckReport, command string) string {
	var sb strings.Builder
	...
	sb.WriteString(fmt.Sprintf("Pre-flight Checks%s\n", modeStr))
	sb.WriteString("================================================================\n\n")
...
func renderDropResultText(result DropResult) string {
	var sb strings.Builder

	sb.WriteString("\n")
	sb.WriteString("Drop Operation Result\n")
	sb.WriteString("================================================================\n")
